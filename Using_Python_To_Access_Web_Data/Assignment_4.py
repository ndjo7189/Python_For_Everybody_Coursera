...
# http://www.pythonlearn.com/code/urllink2.py. The program will use urllib 
# to read the HTML from the data files below, and parse the data, extracting 
...
# Actual data: http://python-data.dr-chuck.net/comments_264277.html 
# (Sum ends with 0)
...
url = raw_input('Enter - ')
if len(url) < 1 : url = "http://python-data.dr-chuck.net/comments_264277.html"
try:
...
# url = 'http://python-data.dr-chuck.net/comments_264277.html'
